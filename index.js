...
const { funcs: qt } = StardustBrowser, Xt = ["index", "selection", "expand", "radio", "_index"], Ce = {
  ...
  methods: {
    ...
    setRich(e) {
      ...
      s.forEach((V) => {
        var N;
        let F = V[v] || "未知";
        if (O && $.length >= o.series.limit && !$.includes(F)) {
        ...
        if (h) {
          ...
          k[M] || R.push(M), k[M] || (k[M] = {}), $.includes(F) || $.push(F), (N = k[M])[F] || (N[F] = []), k[M][F].push(V[l]);
        } else
          k[F] || $.push(F), k[F] || (k[F] = []), k[F].push(V[l]);
      });
  ...
  Pe((e) => ({
    "7d375bda": e.zoomedHeight,
    "93130d98": e.zoom
  }));
}, Re = Ce.setup;
Ce.setup = Re ? (e, t) => (De(), Re(e, t)) : De;
const ue = (e) => (Se("data-v-047f03b7"), e = e(), ke(), e), zt = { class: "x-chart" }, Wt = {
  class: "chart",
  ref: "el"
...
const Qt = /* @__PURE__ */ E(Ce, [["render", Gt], ["__scopeId", "data-v-047f03b7"]]), Zt = {
...
function gs(e, t, s, l, n, i) {
  ...
  return d(), f(se(s.drawer ? "ElDrawer" : "ElDialog"), b({ draggable: s.draggable }, e.$attrs, {
    ...
    header: c(() => [
      e.$slots.header ? x(e.$slots, "header", { key: 0 }) : (d(), w("span", fs, D(e.$attrs.title), 1)),
      s.drawer ? S("", !0) : (d(), f(o, {
        key: 2,
        name: "FullScreen",
  ...
  return d(), f(h, {
    ...
    default: c(() => [
      m(r, {
        ...
        title: c(() => [
          e.$slots["collapse-title"] ? x(e.$slots, "collapse-title", { key: 0 }) : (d(), w("span", Fs, D(s.title), 1))
        ]),
        default: c(() => [
            ...
            default: c(() => [
              (d(!0), w(I, null, U(p, (y) => (d(), f(o, b({
                ...
                default: c(() => [
                  ...
                  ])) : (d(), w("span", Qn, D(i.calcValue(s.data, y)), 1))
                ]),
                _: 2
              }, [
                s.labelSlot ? {
      ...
      (d(!0), w(I, null, U(n._options, (r) => (d(), f(o, b(e.$attrs, {
        ...
        default: c(() => [
          e.$slots.custom ? x(e.$slots, "custom", {
            ...
            j("span", Pi, D(i.calcMainLabel(r)), 1),
            j("span", Li, D(i.calcRemarkLabel(r)), 1)
          ]))
        ]),
        _: 2
    ...
    (s.mode || e._attrs.mode) === "card" ? (d(), w("div", Qi, [
      (d(!0), w(I, null, U(e._data, (g, $) => (d(), w("div", {
        ...
        (d(!0), w(I, null, U(i.cols, (T, L) => (d(), w("div", {
          ...
          j("span", sl, D(T.label) + ":", 1),
          j("span", nl, D(e.calcValue(g, T)), 1)
        ]))), 128))
      ], 8, Zi))), 128))
      ...
      default: c(() => [
        (d(!0), w(I, null, U(e._data, (g, $) => (d(), f(p, {
          ...
          default: c(() => [
            ...
            i.hasIndex ? (d(), w("span", ll, D($ + 1), 1)) : S("", !0),
            j("span", ol, D(i.calcTitle(g)), 1)
          ]),
          _: 2
        }, 1032, ["onClick"]))), 128))
      ]),
...
const dl = {
  ...
  class: "table",
  ref: "colsTable"
}, hl = ["data-prop"], ml = ["title", "onClick"], pl = /* @__PURE__ */ cl(() => /* @__PURE__ */ j("span", { class: "unit" }, "px", -1)), fl = {
  class: "table",
  ref: "sortsTable"
}, gl = ["data-prop"];
...
const { highdict: _l } = StardustJs, yl = {
  ...
  key: 2,
  class: "collapse-title"
}, Sl = /* @__PURE__ */ j("span", null, "-", -1), kl = ["value", "checked"], $l = { key: 1 };
      ...
      m(A, {
        ...
        default: c(() => [
          m(z, {
            ...
            title: c(() => [
              e.$slots["collapse-title"] ? x(e.$slots, "collapse-title", { key: 0 }) : n.activeNames.length ? (d(), w("span", vl, D(e.title), 1)) : (d(), w("span", wl, [
                C(D(e.title) + "，当前第 ", 1),
                j("span", null, D(e._query.page), 1),
                C(" 页，展示 "),
                j("span", null, D(e._data.length), 1),
                C(" 条数据， 共 "),
                j("span", null, D(e._total || e._data.length), 1),
                C(" 条数据 ")
              ]))
            ]),
            default: c(() => [
                    ...
                    ["selection", "index"].includes(_.type) ? void 0 : {
                      ...
                      fn: c((P) => [
                        _.type === "radio" ? (d(), w("input", {
                          ...
                          }), null, 16, ["modelValue", "onUpdate:modelValue", "disabled"])) : (d(), w("span", $l, D(e.calcValue(P.row, _)), 1))
                        ], 64))
                      ]),
                      key: "0"
                    }
...
const Fl = /* @__PURE__ */ E(Vl, [["render", jl], ["__scopeId", "data-v-6ef6b95e"]]);
const Dl = {
  name: "PcXTableTools",
  inheritAttrs: !1,
  props: {
    ...
    m(k, {
      ...
      default: c(() => [
        m(O, {
          ...
          title: c(() => [
            e.$slots["collapse-title"] ? x(e.$slots, "collapse-title", { key: 0 }) : (d(), w("span", Gl, D(e.title), 1))
          ]),
          default: c(() => [
            e.hideTools !== "" && e.hideTools !== !0 ? (d(), f(h, b({ key: 0 }, e._attrs, {
              domids: e.domids,
...
}, mo = /* @__PURE__ */ Ae(() => /* @__PURE__ */ j("em", null, "点击上传", -1)), po = /* @__PURE__ */ Ae(() => /* @__PURE__ */ j("br", null, null, -1)), fo = /* @__PURE__ */ Ae(() => /* @__PURE__ */ j("br", null, null, -1)), go = {
  key: 0,
  class: "path"
};
function bo(e, t, s, l, n, i) {
  ...
  return d(), f(r, b({
    ...
    default: c(() => [
      ...
      i.filepath ? (d(), w("div", go, D(s.modelValue), 1)) : S("", !0)
    ]),
    _: 1
