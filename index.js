...
const dt = (e) => {
  ...
  const p = () => {
    ...
    return M = Math.floor(M / O), L = Math.floor(L / O), new l(
      V,
      j,
      A,
...
class st extends tt {
  constructor(t) {
    ...
    this.table = i || (s == null ? void 0 : s.table), this.dialog = l || (s == null ? void 0 : s.dialog), this.dbModelName = n, this.idField = o, this.listProp = a, this._isSubmitting = !1, this._isExporting = !1, this._lastSearchParams = null, this._dbTable = null, this._unwatchs = [], oe(() => {
  ...
  async handleLoad() {
    ...
    if (this.table.isInfinite = !0, t || !i)
      return;
...
}, Li = (e, t) => !t.labelTexts || !t.labelTexts.length ? e[t.text] : t.labelTexts.map((i) => e[i])[0], Pi = (e, t) => !t.labelTexts || t.labelTexts.length < 2 ? "" : "(" + t.labelTexts.map((i) => e[i]).slice(1).join(" - ") + ")", Ui = {
  name: "MobileXSelect",
  inheritAttrs: !1,
  props: {
    modelValue: Boolean | Number | String | Array,
...
function Ki(e, t, s, i, l, n) {
  ...
  return d(), f(a, b({
    ...
    default: c(() => [
      (d(!0), _(I, null, N(l._options, (r) => (d(), f(o, b(e.$attrs, {
        key: r[s.text],
        label: r[s.text],
        value: r[s.value]
      }), {
        ...
        default: c(() => [
          m(w, {
            ...
            default: c(() => [
              ...
              F("div", bl, [
                (d(!0), _(I, null, N(l.columns, (g) => (d(), _("div", {
                  key: g.prop,
                  "data-prop": g.prop,
          ...
          m(w, {
            ...
            default: c(() => [
              ...
              F("div", wl, [
                (d(!0), _(I, null, N(l.sorts, (g, C) => (d(), _("div", {
                  key: g[0],
                  "data-prop": g[0],
                  class: "row flex-center"
                }, [
