...
const rt = (e) => {
  ...
  const p = () => {
    ...
    let M = o(2) ? (o(2) + 2) * w : (o(-1) - 2) * w, N = o(2) ? (o(2) + 2) * y : (o(-1) - 2) * y;
    return M = Math.floor(M / O), N = Math.floor(N / O), new l(
      V,
      D,
      A,
  ...
  let i = s;
  if (typeof s[0] != "object" && (i = s.map((n) => ({ text: n, value: n }))), !t.sort)
    return i;
  ...
  s ? ((i === "error" || i === "warning") && (t.type = "fail"), ft(t)) : ht({
    showClose: !0,
    grouping: !0,
    ...t
  });
  ...
  const { isMobile: s = window.isMobile, type: i } = t;
  s ? (i === "error" && (t.type = "danger"), gt(t)) : mt({
    showClose: !0,
    ...t
  });
}, ee = (e) => {
...
const _t = (e, t, s) => {
  ...
  for (let s in e) {
    const i = e[s];
    !i || typeof i != "object" || (s === "table" && e[s]._isBaseTable && He(i, t), s === "dialog" && e[s]._isBaseDialog && Je(i, t), s === "form" && e[s]._isBaseForm && Ce(i, t));
  }
  return e;
}, He = (e, t) => (e.columns.push(...t.filter((s) => s.visible === !1 ? s.canView : s.canView !== !1)), e), Je = (e, t) => (e.formItems = t.filter((s) => s.visible === !1 ? s.canAdd || s.canEdit : s.canAdd !== !1 || s.canEdit !== !1), Ce(e, t), e), Ce = (e, t) => (e._isBaseForm && !e._isBaseDialog && (e.formItems = t.filter((i) => i.visible !== !1)), Ye(e.form, e.formItems), e.initialForm = _e.deepCopy(e.form), e.initialFormRules = _e.deepCopy(e.formRules), we(() => e.formItems, () => {
  Ke(e);
  ...
  return i.forEach((n) => {
    if (e.formRules[n])
      return;
    const o = t.find((O) => O.prop === n), a = o.platform || e.platform || (window.isMobile ? "mobile" : "pc"), r = Qe[a], h = [], p = "options" in o, y = { required: !0, message: `请${o.validator || o.asyncValidator ? "正确" : ""}${p ? "选择" : "输入"}${(o == null ? void 0 : o.label) || n}` };
...
class tt extends et {
  constructor(t) {
    ...
    this.table = i || (s == null ? void 0 : s.table), this.dialog = l || (s == null ? void 0 : s.dialog), this.dbModelName = n, this.idField = o, this.listProp = a, this._isSubmitting = !1, this._isExporting = !1, this._lastSearchParams = null, this._dbTable = null, this._unwatchs = [], le(() => {
  ...
  getAddParams(t) {
    ...
    return s.length ? s.forEach((l) => i[l] = t[l]) : Object.assign(i, t), this.dialog.formItems.forEach((l) => {
      ...
      l.type === "number" ? n = this.uiUtils.formatPrecision(n, l.precision || 3) * 1 : l.comp === "ElDatePicker" && (l.type === "datetime" ? n = pe.format(n) : (!l.type || l.type === "date") && (n = pe.format(n, "", !1))), i[l.model || l.prop] = n;
    }), i;
  }
  getUpdateParams(t) {
...
function Rt(e, t, s, i, l, n) {
  const o = u("x-col"), a = u("x-row");
  return d(), v("div", jt, [
    (d(!0), v(I, null, L(n.rows, (r, h) => (d(), f(a, b({ key: h }, e.$attrs, {
      platform: e.$attrs.platform
    }), {
      default: c(() => [
        (d(!0), v(I, null, L(r, (p, w) => (d(), f(o, b(p, {
          span: p.span || s.span,
          key: w,
          platform: e.$attrs.platform
        }), {
...
const Bt = /* @__PURE__ */ E(Tt, [["render", Rt]]), It = {
  name: "MobileXButton"
};
...
const Nt = /* @__PURE__ */ E(It, [["render", Mt]]), Lt = {
  name: "PcXButton"
};
function Pt(e, t, s, i, l, n) {
  const o = u("el-button");
  return d(), f(o, null, {
    default: c(() => [
      x(e.$slots, "default")
    ...
    setRich(e) {
      ...
      s.forEach((V) => {
        ...
        if (h) {
          ...
          k[N] || R.push(N), k[N] || (k[N] = {}), C.includes(D) || C.push(D), (M = k[N])[D] || (M[D] = []), k[N][D].push(V[i]);
        } else
...
function es(e, t, s, i, l, n) {
  ...
  return d(), f(a, b({ class: "mobile-x-checkboxs" }, n.attrs, {
    ...
    default: c(() => [
      (d(!0), v(I, null, L(n.formatOptions(s.options, this), (r) => (d(), f(o, b(n.attrs, {
        key: r[s.text],
        shape: s.shape,
        name: r[s.value]
      }), {
...
function ms(e, t, s, i, l, n) {
  ...
  return d(), f(o, b({ width: "92%" }, e.$attrs, {
    ...
    e.$slots.title || s.title ? {
      name: "title",
      fn: c(() => [
        e.$slots.title ? x(e.$slots, "title", { key: 0 }) : (d(), v("span", hs, j(s.title), 1))
      ]),
      key: "0"
    } : void 0,
    e.$slots.header ? {
...
function bs(e, t, s, i, l, n) {
  ...
  return d(), f(se(s.drawer ? "ElDrawer" : "ElDialog"), b({ draggable: s.draggable }, e.$attrs, {
    ...
    header: c(() => [
      e.$slots.header ? x(e.$slots, "header", { key: 0 }) : (d(), v("span", gs, j(s.title), 1)),
      s.drawer ? S("", !0) : (d(), f(o, {
        key: 2,
        name: "FullScreen",
...
function Fs(e, t, s, i, l, n) {
  ...
  return d(), f(r, {
    ...
    default: c(() => [
      ...
      m(a, de(Ue(e.$attrs)), {
        default: c(() => [
          (d(!0), v(I, null, L(e._visibleItems, (h, p) => (d(), f(o, b(h, {
...
const Ts = /* @__PURE__ */ E(Os, [["render", Fs]]), js = {
  name: "PcXForm",
  inheritAttrs: !1,
  props: {
    ...ne.props(),
  ...
  return d(), f(h, {
    ...
    default: c(() => [
      m(r, {
        ...
        title: c(() => [
          e.$slots["collapse-title"] ? x(e.$slots, "collapse-title", { key: 0 }) : (d(), v("span", Ds, j(s.title), 1))
        ]),
        default: c(() => [
          m(a, b({ ref: "formRef" }, e.$attrs, {
            ...
            default: c(() => [
              e.$slots.pre ? x(e.$slots, "pre", { key: 0 }) : S("", !0),
              (d(!0), v(I, null, L(e._visibleItems, (p, w) => (d(), f(o, b({
                "label-width": s.labelWidth,
...
const Bs = /* @__PURE__ */ E(js, [["render", Rs]]);
function Is(e) {
...
const Ps = /* @__PURE__ */ E(xe, [["__scopeId", "data-v-d2cde1e2"]]), Me = /* @__PURE__ */ Object.assign({}), Us = {
  name: "MobileXIcon",
  props: {
    name: String
  },
...
function En(e, t) {
  ...
  if (i || l) {
    ...
    if (o in e)
      return e[o];
    if (l)
      return typeof l == "function" ? l(n, e, t) : Ys.get(e, l);
  }
  return n;
}
function An(e) {
...
function ti(e, t, s, i, l, n) {
  ...
  return d(), f(h, {
    ...
    default: c(() => [
      (d(!0), v(I, null, L(n.blocks, (p, w) => (d(), f(r, {
        key: w,
        title: w,
        name: w
      }, {
        default: c(() => [
          m(a, {
            ...
            default: c(() => [
              (d(!0), v(I, null, L(p, (y) => (d(), f(o, b({
                key: y.prop
              }, y), te({
                default: c(() => [
                  y.slot ? (d(), v("span", Zn, [
                    x(e.$slots, y.slot, de(Ue({ data: s.data, field: y, value: n.calcValue(s.data, y) })), void 0, !0)
                  ])) : (d(), v("span", ei, j(n.calcValue(s.data, y)), 1))
                ]),
                _: 2
              }, [
                s.labelSlot ? {
...
function li(e, t, s, i, l, n) {
  return d(), v("div", null, [
    (d(!0), v(I, null, L(s.items, (o, a) => (d(), f(se(s.compName), b({ key: a }, o), {
      default: c(() => [
        o.slot || e.$attrs.slot ? x(e.$slots, "default", {
          key: 0,
          item: o
        }) : (d(), v("span", ii, j(o.text), 1))
      ]),
      _: 2
    }, 1040))), 128))
  ]);
...
function bi(e, t, s, i, l, n) {
  ...
  return d(), f(a, b({ class: "mobile-x-radios" }, e.$attrs, { direction: s.direction }), {
    default: c(() => [
      (d(!0), v(I, null, L(n.formatOptions(s.options, this), (r) => (d(), f(o, b(e.$attrs, {
        key: r[s.text],
        name: r[s.value]
      }), {
        default: c(() => [
...
function vi(e, t, s, i, l, n) {
  ...
  return d(), f(o, b({
    ...
    default: c(() => [
      (d(!0), v(I, null, L(n.formatOptions(s.options, this), (a) => (d(), f(se(s.button ? "el-radio-button" : "el-radio"), b(n.attrs, {
        key: a[s.text],
        label: a[s.value]
      }), {
        default: c(() => [
...
function Ci(e, t, s, i, l, n) {
  ...
  return d(), f(a, { class: "mobile-x-row" }, {
    default: c(() => [
      (d(!0), v(I, null, L(s.cols, (r, h) => (d(), f(o, b(r, { key: h }), {
        default: c(() => [
          r.slot || e.$attrs.slot ? x(e.$slots, r.slot || e.$attrs.slot, {
            key: 0,
            col: r
          }) : (d(), v("span", ki, j(r.text), 1))
        ]),
        _: 2
      }, 1040))), 128)),
...
const Ri = /* @__PURE__ */ E(ji, [["render", Di]]), nt = async (e, t, s) => {
  s.loading = !0;
...
}, Bi = (e, t) => !t.labelTexts || !t.labelTexts.length ? e[t.text] : t.labelTexts.map((i) => e[i])[0], Ii = (e, t) => !t.labelTexts || t.labelTexts.length < 2 ? "" : "(" + t.labelTexts.map((i) => e[i]).slice(1).join(" - ") + ")", Mi = {
  name: "MobileXSelect",
  inheritAttrs: !1,
  props: {
    modelValue: Boolean | Number | String | Array,
...
function zi(e, t, s, i, l, n) {
  ...
  return d(), f(a, b({
    ...
    default: c(() => [
      (d(!0), v(I, null, L(l._options, (r) => (d(), f(o, b(e.$attrs, {
        key: r[s.text],
        label: r[s.text],
        value: r[s.value]
      }), {
        default: c(() => [
          e.$slots.custom ? x(e.$slots, "custom", {
            ...
            text: s.text,
            value: s.value
          }, void 0, !0) : (d(), v("span", Ui, [
            F("span", qi, j(n.calcMainLabel(r)), 1),
            F("span", Xi, j(n.calcRemarkLabel(r)), 1)
          ]))
        ]),
        _: 2
...
const Wi = /* @__PURE__ */ E(Pi, [["render", zi], ["__scopeId", "data-v-d36889f6"]]), Le = {
  eq: {
    text: "等于",
    value: "eq"
  },
...
function Ji() {
  ...
  return m(u("x-dialog"), b({
    ...
    }, [Ki(this, y)])])]))]), t.traditional ? null : m(u("el-input"), b({
      type: "textarea",
      autosize: {
        minRows: 3,
        maxRows: 10
  ...
  methods: {
    ...
    initConfig(e) {
      ...
      (t = e.conditions) == null || t.forEach((i) => {
        ...
        i.item = this.columns.find((a) => a.prop === l), this.handleSelectField(i, l), this.handleSelectOp(i, n), i.value = o, i.ops = X[i.component].map((a) => Le[a]);
    ...
    handleSelectField(e, t) {
      ...
      A.clearable ?? (A.clearable = !0), e.config = A, e.component = o || s && "XSelect" || i === "number" && "ElInputNumber" || "ElInput", e.ops = X[e.component].map((V) => Le[V]), e.op = e.ops[0].value, e.component === "ElDatePicker" && (e.component = "ElInput", A.type = "date"), A.type === "textarea" && delete A.type;
    },
    handleSelectOp(e, t) {
...
function dl(e, t, s, i, l, n) {
  ...
  return d(), v("div", Zi, [
    ...
    (s.mode || e._attrs.mode) === "card" ? (d(), v("div", el, [
      (d(!0), v(I, null, L(e._data, (g, C) => (d(), v("div", {
        key: C,
        class: "row",
        ...
        (d(!0), v(I, null, L(n.cols, (T, q) => (d(), v("div", {
          key: q,
          class: "field"
        }, [
          F("span", il, j(T.label) + ":", 1),
          F("span", ll, j(e.calcValue(g, T)), 1)
        ]))), 128))
      ], 8, tl))), 128))
      ...
      default: c(() => [
        (d(!0), v(I, null, L(e._data, (g, C) => (d(), f(p, {
          key: C,
          "is-link": "",
          ...
          default: c(() => [
            ...
            n.hasIndex ? (d(), v("span", al, j(C + 1), 1)) : S("", !0),
            F("span", rl, j(n.calcTitle(g)), 1)
          ]),
          _: 2
        }, 1032, ["onClick"]))), 128))
      ]),
...
const cl = /* @__PURE__ */ E(Qi, [["render", dl], ["__scopeId", "data-v-84e93229"]]), ul = {
  ...
  class: "table",
  ref: "colsTable"
}, pl = ["data-prop"], fl = ["title", "onClick"], gl = /* @__PURE__ */ hl(() => /* @__PURE__ */ F("span", { class: "unit" }, "px", -1)), bl = {
  class: "table",
  ref: "sortsTable"
}, _l = ["data-prop"];
function yl(e, t, s, i, l, n) {
        ...
        default: c(() => [
          m(w, {
            ...
            default: c(() => [
              ...
              F("div", ml, [
                (d(!0), v(I, null, L(l.columns, (g) => (d(), v("div", {
                  key: g.prop,
                  "data-prop": g.prop,
          ...
          m(w, {
            ...
            default: c(() => [
              ...
              F("div", bl, [
                (d(!0), v(I, null, L(l.sorts, (g, C) => (d(), v("div", {
                  key: g[0],
                  "data-prop": g[0],
                  class: "row flex-center"
                }, [
  ...
  methods: {
    ...
    async search() {
      ...
      if (e && this.controller.getSearchParams) {
        ...
        let n = vl.get(l, this.controller.listProp);
...
function Vl(e, t, s, i, l, n) {
  ...
  return d(), v(I, null, [
    F("div", {
      ...
      m(A, {
        modelValue: l.activeNames,
        "onUpdate:modelValue": t[4] || (t[4] = (_) => l.activeNames = _),
        ...
        default: c(() => [
          m(z, {
            ...
            title: c(() => [
              e.$slots["collapse-title"] ? x(e.$slots, "collapse-title", { key: 0 }) : l.activeNames.length ? (d(), v("span", Sl, j(e.title), 1)) : (d(), v("span", kl, [
                $(j(e.title) + "，当前第 ", 1),
            ...
            default: c(() => [
              e.hideTools !== "" && e.hideTools !== !0 ? (d(), f(h, b({ key: 0 }, e._attrs, {
                ...
                "tools-end": c(() => [
                  ...
                  m(r, {
                    ...
                    "onUpdate:modelValue": t[1] || (t[1] = (_) => l.settings = _),
              ...
              B((d(), f(T, b({ ref: "tableRef" }, e.elTableAttrs, {
                ...
                default: c(() => [
                  (d(!0), v(I, null, L(e._visibleColumns, (_, H) => (d(), f(O, b(_, {
                    key: H,
                    ...
                    ["selection", "index"].includes(_.type) ? void 0 : {
                      ...
                      fn: c((P) => [
                        _.type === "radio" ? (d(), v("input", {
                          ...
                          }), null, 16, ["modelValue", "onUpdate:modelValue", "disabled"])) : (d(), v("span", xl, j(e.calcValue(P.row, _)), 1))
                        ], 64))
                      ]),
                      key: "0"
                    }
    ...
    e.hideChart ? S("", !0) : (d(), f(D, {
      key: 0,
      modelValue: l.dialog.visible,
      "onUpdate:modelValue": t[5] || (t[5] = (_) => l.dialog.visible = _),
      title: "图表",
      width: "96%",
...
}, Ol = { class: "mobile-x-table-tools" }, Fl = { key: 0 }, Tl = { class: "tools" }, jl = { class: "tools-end" };
function Dl(e, t, s, i, l, n) {
  const o = u("van-floating-bubble"), a = u("mobile-x-icon"), r = u("van-button"), h = ie("domid");
  return d(), v("div", Ol, [
    e.$attrs.onAdd ? B((d(), v("div", Fl, [
      m(o, {
        axis: "xy",
        magnetic: "x",
        icon: "plus",
...
const Ll = /* @__PURE__ */ E(Bl, [["render", Nl], ["__scopeId", "data-v-368940cf"]]);
function lt(e) {
  return typeof e == "function" || Object.prototype.toString.call(e) === "[object Object]" && !qe(e);
}
const Pl = (e) => {
  ...
  const {
    ...
    return r.type === "selection" && (r.width = r.width || 46, r.headerCellRenderer = Pl(t)), r.cellRenderer = Kl(r, t), r;
  });
  return t.hideOperates || l.push({
    ...
    cellRenderer(n) {
      return m("div", {
        class: "operates"
      }, [i["operates-prefix"] ? i["operates-prefix"]() : null, zl(n, t), Wl(n, t), Hl(n, t), Jl(n, t), i["operates-suffix"] ? i["operates-suffix"]() : null]);
    }
  }), l;
}, Gl = {
    ...
    m(k, {
      ...
      default: c(() => [
        m(O, {
          ...
          title: c(() => [
            e.$slots["collapse-title"] ? x(e.$slots, "collapse-title", { key: 0 }) : (d(), v("span", Zl, j(e.title), 1))
          ]),
          default: c(() => [
            e.hideTools !== "" && e.hideTools !== !0 ? (d(), f(h, b({ key: 0 }, e._attrs, {
              domids: e.domids,
...
}, ao = { class: "x-tinymce" }, ro = ["id", "innerHTML"];
function co(e, t, s, i, l, n) {
  return d(), v("div", ao, [
    F("textarea", {
      id: l.id,
...
const uo = /* @__PURE__ */ E(oo, [["render", co]]), ho = {
  name: "XFileUploader",
  props: {
...
}, Ae = (e) => (Se("data-v-a3a105f3"), e = e(), ke(), e), mo = { class: "mask" }, po = {
  key: 0,
  class: "el-upload__text"
}, fo = /* @__PURE__ */ Ae(() => /* @__PURE__ */ F("em", null, "点击上传", -1)), go = /* @__PURE__ */ Ae(() => /* @__PURE__ */ F("br", null, null, -1)), bo = /* @__PURE__ */ Ae(() => /* @__PURE__ */ F("br", null, null, -1)), _o = {
  key: 0,
  class: "path"
};
function yo(e, t, s, i, l, n) {
  ...
  return d(), f(r, b({
    ...
    default: c(() => [
      ...
      n.filepath ? (d(), v("div", _o, j(s.modelValue), 1)) : S("", !0)
    ]),
    _: 1
  }, 16, ["file-list", "disabled", "action", "accept", "multiple", "on-success"]);
}
const vo = /* @__PURE__ */ E(ho, [["render", yo], ["__scopeId", "data-v-a3a105f3"]]), wo = {
  name: "XImageUploader",
  props: {
    modelValue: Array | String,
    multiple: Boolean,
...
const Co = /* @__PURE__ */ E(wo, [["render", ko], ["__scopeId", "data-v-87a71ccc"]]), be = {
  xactionsheet: Ft,
  xautorows: Bt,
  mobilexbutton: Nt,
  pcxbutton: Ut,
...
const $o = (e) => ({
  ...
  const e = Object.keys(oe), t = [...new Set(e.map((i) => i.replace(/(pc|mobile)/i, "")))], s = {};
  for (const i of e)
    /(pc|mobile)/i.test(i) && (s[i] = oe[i]);
  for (const i of t)
    e.find((l) => /(pc|mobile)/i.test(l) && l.toLowerCase().includes(i.toLowerCase())) ? s[i] = $o(i) : s[i] = oe[i];
  return s;
})(), xo = (e, t) => {
  for (let s in ve)
    e.component(s, ve[s]);
